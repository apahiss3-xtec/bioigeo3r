...
// Fitxes reals (HTML, A/B/C) a public/fitxes/. fitxaUrl és { A, B, C } i es
// tria segons el nivell seleccionat (mateix mecanisme que pickLevel).
...
export default function SessionPage() {
  ...
  if (!sa || !sa.published || !session) return <NotFoundPage />
