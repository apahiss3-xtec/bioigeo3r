export const sa7s4 = {
  ...
  apartatExtras: {
    ...
    "3": {
      scaffold: "Per a la resolució de l'enigma, omple els espais: 1) Els terratrèmols del Pirineu es deuen a: la col·lisió de les plaques ___ i ___ fa ___-___ Ma. Aquesta col·lisió va crear falles que ___ (són/no són) actives avui. 2) Els volcans de la Garrotxa es deuen a: un procés de ___ (rift/subducció) postalpí que va estirar la litosfera i va permetre que el mantell pujés i generés magma ___. El darrer volcà va erupcionar fa ≈___ anys.",
  ...
  ideesPrevies: {
    ...
    prompts: [
      {
        kind: "write",
        text: "Ara que hem estudiat les tres famílies de roques i la tectònica de plaques, escull una de les 6 fotografies i intenta explicar quin procés geològic l'ha format. No cal que sigui perfecte — usa el que has après.",
        starter: "He escollit la fotografia de ___ perquè... Crec que el procés geològic és... perquè la roca..."
      },
      {
        kind: "write",
  ...
  exploreInstructions: [
    "Producte final: Guia geològica de l'entorn (en grups de 3-4). Cada grup rep un indret de l'entorn proper (del barri, de la comarca o de Catalunya) i construeix una pàgina per a la guia col·lectiva",
    "La pàgina de la guia inclou (fitxa format A5): nom de l'indret / foto o il·lustració / tipus de roca predominant / procés geològic que l'ha format / edat aproximada / recurs humà (si n'hi ha) / 1 impacte ambiental + 1 mesura de conservació",
  ...
  exploreMaterials: ["Fitxa format A5 per a la pàgina de la guia (1 per grup)", "Accés al formulari Google de síntesi (QR)", "Projector: galeria de paisatges de Catalunya + context geològic de cada un"],
  ...
  theoryPoints: [
    ...
    },
    {
      ...
      text: "Cada zona de Catalunya té la seva «signatura geològica»: 1) ==Pirineus|b==: col·lisió alpina (55-35 Ma) entre plaques Ibèrica i Euràsia. Roques: granits i gneis al Pirineu axial (hercínics, 300 Ma) + calcàries i pissarres als Pre-pirineus (Mesozoic). 2) ==Garrotxa|r==: camp volcànic de rift postalpí. 40 cons volcànics i 20 colades de basalt. Darrera erupció ≈11.500 anys AP. ==Volcà actiu latent|r==. 3) ==Montserrat|o==: conglomerat cretaci (≈60 Ma) erosionat de forma espectacular per l'aigua → formes «inselberg». 4) ==Delta de l'Ebre|g==: sediments al·luvials en deposició activa. S'allarga cap al mar ≈5 m/any, però la construcció de pantans n'ha reduït el sediment. 5) ==Cardona|o== (Bages): diapir de sal (evaporita del Triàsic, ≈230 Ma) → la Muntanya de Sal. 6) ==Costa Brava|b==: granits hercínics erosionats per la mar Mediterrània → cales, illes i esculls.",
      type: "concept"
    },
    {
      id: "t3",
  ...
  fitxaGuide: {
    ...
    steps: [
      { apartat: "0", title: "Idees prèvies: hipòtesi inicial sobre el paisatge", time: "5 min", phase: "engage", instruction: "Apartat 0: escull una fotografia del paisatge de Catalunya i escriu la teva hipòtesi del procés geològic que l'ha format. Anota el que recordes de les pistes 1, 2 i 3 de l'enigma.", hints: [] },
      { apartat: "1", title: "Guia geològica del vostre indret (producte final)", time: "30 min", phase: "explore", instruction: "Apartat 1: construeix la pàgina de la guia geològica del vostre indret. Segueix el format de la fitxa A5: roca / procés / edat / ús / impacte / conservació. Presenteu-la al grup classe.", hints: [
        "Si no trobes la informació de l'indret, usa la teoria de S1-S3 com a base. Identifica primer el tipus de roca → busca el procés geològic que genera aquell tipus de roca en aquella zona.",
      ...
      { apartat: "2", title: "Paisatge de Catalunya i lectura geològica", time: "10 min", phase: "explica", instruction: "Apartat 2: completa la taula dels 6 paisatges de Catalunya (G1): indret / roca predominant / procés geològic / edat aproximada. Per a cada paisatge, respon en 1 frase per quina raó és com és.", hints: [
        "Montserrat = conglomerat (sedimentari del Cretaci) erosionat diferencialment per l'aigua → boles i agulles. Costa Brava = granit hercínic (300 Ma) erosionat per la mar → cales. Cardona = evaporita triàsica (sal gemma, 230 Ma) → diapir de sal."
      ] },
