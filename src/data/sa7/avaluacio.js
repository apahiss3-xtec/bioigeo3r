...
export const sa7Avaluacio = {
  checklist: [
    ...
    { id: 'c9', oa: 'OA3', text: "Explico per quina raó el ciment és un dels materials amb major impacte climàtic (descarbonatació: CaCO₃→CaO+CO₂ a 1.450°C, ≈8% emissions globals) i el relaciono amb el cicle del carboni geològic (connexió SA6)." },
    ...
    questions: [
      {
        ...
        options: [
          "Els Apenins són el resultat de la col·lisió de la placa Adriàtica (microplaca) i la placa Euràsia — límit convergent continental, similar al Pirineu. L'acumulació de tensió en les falles dels Apenins es va alliberar sobtadament → terratrèmol M6,3. L'hipocentre poc profund (8,8 km) fa que les ones sísmiques arriben a la superfície amb molta energia sense haver-se atenuat: a 8 km, l'epicentre és molt proper (àrea de màxima intensitat petita però molt intensa). A 100 km, les ones han recorregut molt més camí i perden energia → menys destrucció local",
          ...
          "Els Apenins són una dorsal oceànica sota terra. El límit divergent entre plaques genera terratrèmols sense volcans a la superfície. L'hipocentre poc profund no té cap efecte en la intensitat en superfície",
      ...
      },
      {
        ...
        options: [
          ...
          "Tant l'Etna com la Garrotxa són volcans de subducció de la mateixa placa (Adriàtica). La diferència és la profunditat de la subducció: en superfície genera basalt, en profunditat genera granit"
        ],
        correct: 0,
        feedback: {
          ...
          wrong: "Pensa en el mecanisme de generació del magma. Subducció (Itàlia sud): la placa oceànica africana s'enfonsa → s'hidrata en fondre's → l'aigua baixa el punt de fusió del mantell → magma silícic = ric en sílice i gasos = explosiu. Rift (Garrotxa): extensió litosfèrica → baixa la pressió → el mantell fon parcialment → magma basàltic = pobre en sílice = fluid = efusiu. La diferència és: alt vs baix contingut en SiO₂ = explosiu vs efusiu."
        }
      },
      {
        id: 't3',
        oa: 'OA4',
        text: "L'Aquila és una ciutat medieval construïda sobre sediments de valle (roca al·luvial poc consolidada). Els barris construïts sobre el substrat de roca sòlida (calcari dels Apenins) van patir molts menys danys que els barris sobre sediments. Explica per quina raó el substrat geològic influeix en l'intensitat d'un terratrèmol i argumenta per quina raó els plans urbanístics haurien de tenir en compte la geologia del sòl.",
        options: [
          "Els sediments tous (sorra, argila, al·luvions) ampliquen les ones sísmiques (efecte d'amplificació sísmica o 'efecte sòl'): les ones es mouen més lentament, l'amplitud augmenta i els edificis reben una acceleració major. A més, els sediments saturats d'aigua poden liquidar-se (liquefacció sísmica). La roca sòlida (calcari) transmet les ones sense amplificar-les. Per tant, la geologia del substrat hauria de ser un criteri obligatori en el planejament urbanístic: zona de risc alt (sediments) vs zona de risc baix (roca sòlida)",
          "El substrat geològic no influeix en l'intensitat del terratrèmol. L'únic factor que importa és la distància a l'epicentre: com més lluny, menys danys. Els edificis de L'Aquila van caure per deficiències constructives, no per la geologia del sòl",
        ...
        feedback: {
          ...
          wrong: "Pensa en el comportament de les ones en materials de diferent rigidesa. Els sediments tous (argila, sorra, al·luvions) són menys rígids → les ones sísmiques s'alenteixen → l'amplitud augmenta → els edificis oscil·len més. Analogia: si agites gelatina vs pedra sòlida, quina oscil·la més? La gelatina (sediment) amplifica el moviment. Per això, la microzonació sísmica (conèixer el substrat) és obligatòria en la planificació urbanística a Itàlia, Japó i Califòrnia (i hauria de ser-ho arreu)."
        }
      },
      {
        id: 't4',
        ...
        options: [
          ...
          "El càlcul és impossible perquè el ciment no emet CO₂ durant la producció: el CO₂ s'emet tan sols durant la destrucció dels edificis. Les alternatives de menys petjada són sempre pitjors sísmica, de manera que no hi ha alternativa real al formigó armat en zones sísmiques",
          "Càlcul: 500.000 tones × 0,9 = 450.000 tones CO₂. Però les emissions són compensables plantant arbres: 1 arbre absorbeix ≈22 kg CO₂/any → caldrien ≈20 milions d'arbres per compensar en 1 any. Conclusió: la compensació forestal és sempre la millor solució",
