          ...
          >
            <div className="flex items-center justify-between gap-2">
              ...
              <button
                ...
                className="tap rounded-full px-1.5 text-sm font-bold leading-none hover:bg-[var(--bg-soft)]"
            ...
            <div className="mt-2 flex flex-col gap-1">
              {MODES.map((m) => (
                <button
                  ...
                  className="tap rounded-lg px-2 py-1 text-left text-xs font-semibold"
                  style={
                    modeId === m.id
            ...
            <button
              ...
              className="tap mt-2 w-full rounded-xl px-3 py-1.5 text-xs font-semibold text-white"
